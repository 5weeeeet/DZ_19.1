                        ...
                        <div class="card mb-4 rounded-3 shadow-sm">
                            ...
                            <div class="d-grid gap-2 d-md-block">
                                <button class="btn btn-primary" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#how_buy" aria-expanded="false">Как
                                    купить?
                                </button>
                                <button class="btn btn-primary" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#how_to_deliver" aria-expanded="false">Как доставить?
                                </button>
                                <button class="btn btn-primary" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#warranty" aria-expanded="false">Какая гарантия?
                                </button>
                                <div class="collapse" id="how_buy">
                                    <div class="card card-body">
                                        Покупка - приобретение чего-либо в собственность за деньги или иные ценности.
                                    </div>
                                </div>
                                <div class="collapse" id="how_to_deliver">
                                    <div class="card card-body">
                                        Доставка - процесс перемещения груза /объекта в место назначения, посредством тех
                                        или иных транспортных средств.
                                    </div>
                                </div>
                                <div class="collapse" id="warranty">
                                    <div class="card card-body">
                                        Гарантия - поручительство за выполнение определенным лицом денежных или вещественных
                                        обязательств, форма ответственности за выполнение принятых обязательств
                                    </div>
                                </div>
                            </div>
                        </div>
